...
// SELECT = memilih data apa saja yang mau diambil
// input_aspirasi.* = ambil semua kolom dari tabel input_aspirasi (tabel utama)
// kategori.ket_kategori = ambil nama kategori dari tabel kategori
// user.username = ambil username dari tabel user

// FROM input_aspirasi = tabel utama (data aspirasi disimpan di sini)

// LEFT JOIN kategori = menggabungkan tabel kategori ke input_aspirasi
// ON input_aspirasi.id_kategori = kategori.id_kategori
// artinya mencocokkan id_kategori di kedua tabel supaya bisa ambil nama kategori

// LEFT JOIN user = menggabungkan tabel user
// ON input_aspirasi.nis = user.nis
// artinya mencocokkan nis supaya bisa ambil username

// WHERE user.nis = '$nis' = filter data
// hanya menampilkan data aspirasi milik user yang sedang login

// tujuan keseluruhan:
// ambil semua data aspirasi + nama kategori + username
// tapi hanya yang punya user yang login (berdasarkan nis)
?>
