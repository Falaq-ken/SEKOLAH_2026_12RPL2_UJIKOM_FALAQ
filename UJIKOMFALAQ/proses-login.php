...
// mysqli_fetch_assoc() = mengambil 1 baris hasil query dari database
// lalu mengubahnya menjadi array associative (array dengan nama kolom sebagai key)

// kenapa harus dijadiin array?
// supaya data dari database bisa diakses dengan mudah di PHP

// kalau tidak pakai mysqli_fetch_assoc():
// data dari query tidak bisa langsung dipakai / diakses ❌

// catatan:
// - hanya mengambil 1 baris data (bukan semua)
// - kalau data tidak ada → hasilnya NULL

// biasanya dipakai untuk:
// - login (ambil 1 user)
// - detail data (ambil 1 data berdasarkan id)

// tujuan keseluruhan:
// ambil data dari database → ubah jadi array → biar bisa dipakai di PHP
