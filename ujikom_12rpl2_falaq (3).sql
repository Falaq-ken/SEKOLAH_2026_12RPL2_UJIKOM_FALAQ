...
--
-- Host: localhost:3306
-- Generation Time: Feb 25, 2026 at 04:15 AM
...
(2, '1233', 1, '2026-02-25 09:42:43', 'sekolah', 'becek', 'selesai', 'okee'),
(3, '1233', 1, '2026-02-25 09:43:04', 'kelas', 'kipas rusak', 'menunggu', 'kalem'),
(4, '1234', 2, '2026-02-25 10:46:28', 'sekolah', 'parkir sempit', 'menunggu', NULL),
(5, '1234', 1, '2026-02-25 10:46:59', 'lab', 'komputer', 'menunggu', NULL),
(6, '4321', 2, '2026-02-25 10:47:42', 'bukan kelas', 'gapapa sih', 'menunggu', NULL);
...
--
ALTER TABLE `input_aspirasi`
  MODIFY `id_pelapor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `kategori`
--
ALTER TABLE `kategori`
  MODIFY `id_kategori` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1228;
